...
class DefaultAssetLibrary extends AssetLibrary {
	...
	public function new () {
		...
		className.set ("assets/images/autotiles.png", __ASSET__assets_images_autotiles_png);
		type.set ("assets/images/autotiles.png", AssetType.IMAGE);
		...
		type.set (id, AssetType.TEXT);
		id = "assets/images/autotiles.png";
		path.set (id, id);
...
@:keep @:bind #if display private #end class __ASSET__assets_images_autotiles_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
...
@:file("assets/data/map.csv") #if display private #end class __ASSET__assets_data_map_csv extends lime.utils.Bytes {}
@:image("assets/images/autotiles.png") #if display private #end class __ASSET__assets_images_autotiles_png extends lime.graphics.Image {}
